...
public class Screenshots {
    ...
    public static String takePageScreenShot(String filename) {
        ...
        File screenshotsDir = new File(System.getProperty("user.dir") + Base.prop.getProperty("screenshot")); //Base.prop.getProperty("screenshot")
    ...
    public static String takeElementScreenShot(By elementLocator, String fileName) {
        ...
        try {
            ...
            File target = new File(System.getProperty("user.dir") + Base.prop.getProperty("screenshot"));
            if (!target.exists()) {
                target.mkdirs();
            }
    ...
    public static void captureHighlightedElementScreenshot( By locator, String filename) {
        ...
        try {
            ...
            File screenshotsDir = new File(System.getProperty("user.dir") + Base.prop.getProperty("screenshot")); //"/screenshorts"
